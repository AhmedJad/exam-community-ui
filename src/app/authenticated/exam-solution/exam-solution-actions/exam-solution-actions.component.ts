...
@Component({
  selector: 'exam-solution-actions',
  templateUrl: './exam-solution-actions.component.html',
  styleUrls: ['./exam-solution-actions.component.scss']
})
export class ExamSolutionActionsComponent implements OnInit {
